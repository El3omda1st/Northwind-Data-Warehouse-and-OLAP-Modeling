...
INSERT INTO "northwind"."customer" (id, company, last_name, first_name, email_address, job_title, business_phone, home_phone, mobile_phone, fax_number, address, city, state_province, zip_postal_code, country_region, web_page, notes, attachments)
VALUES
...
INSERT INTO "northwind"."employee_privileges" (employee_id, privilege_id)
VALUES
(2, 2);

-- Dumping data for table '"northwind"."inventory_transaction_types"'


INSERT INTO "northwind"."inventory_transaction_types" (id, type_name)
VALUES
(1, 'Purchased');
INSERT INTO "northwind"."inventory_transaction_types" (id, type_name)
VALUES
...
-- Dumping data for table '"northwind"."inventory_transactions"'


INSERT INTO "northwind"."inventory_transactions" (id, transaction_type, transaction_created_date, transaction_modified_date, product_id, quantity, purchase_order_id, customer_order_id, comments)
VALUES
...
-- Dumping data for table '"northwind"."invoices"'


INSERT INTO "northwind"."invoices" (id, order_id, invoice_date, due_date, tax, shipping, amount_due)
VALUES
...
-- Dumping data for table '"northwind"."order_details"_status'


INSERT INTO "northwind"."order_details_status" (id, status)
VALUES
(0, 'None');
INSERT INTO "northwind"."order_details_status" (id, status)
VALUES
...
INSERT INTO "northwind"."orders" (id, employee_id, customer_id, order_date, shipped_date, shipper_id, ship_name, ship_address, ship_city, ship_state_province, ship_zip_postal_code, ship_country_region, shipping_fee, taxes, payment_type, paid_date, notes, tax_rate, tax_status_id, status_id)
VALUES
...
--# Dumping data for table '"northwind"."orders"_status'


INSERT INTO "northwind"."orders_status" (id, status_name)
VALUES
(0, 'New');
INSERT INTO "northwind"."orders_status" (id, status_name)
VALUES
...
-- Dumping data for table '"northwind"."orders"_tax_status'


INSERT INTO "northwind"."orders_tax_status" (id, tax_status_name)
VALUES
(0, 'Tax Exempt');
INSERT INTO "northwind"."orders_tax_status" (id, tax_status_name)
VALUES
...
INSERT INTO "northwind"."privileges" (id, privilege_name)
VALUES
...
INSERT INTO "northwind"."products" (supplier_ids, id, product_code, product_name, description, standard_cost, list_price, reorder_level, target_level, quantity_per_unit, discontinued, minimum_reorder_quantity, category, attachments)
VALUES
('5', 72, 'NWTD-72', 'Northwind Traders Mozzarella', NULL, 26.1, 34.8, 10, 40, '24 - 200 g pkgs.', 0, 10, 'Dairy "northwind"."products"', '');
INSERT INTO "northwind"."products" (supplier_ids, id, product_code, product_name, description, standard_cost, list_price, reorder_level, target_level, quantity_per_unit, discontinued, minimum_reorder_quantity, category, attachments)
VALUES
...
-- Dumping data for table 'purchase_"northwind"."purchase_order_details"'

INSERT INTO "northwind"."purchase_order_details" (id, purchase_order_id, product_id, quantity, unit_cost, date_received, posted_to_inventory, inventory_id)
VALUES
...
--# Dumping data for table "northwind"."purchase_order_status"


INSERT INTO "northwind"."purchase_order_status" (id, status)
VALUES
(0, 'New');
INSERT INTO "northwind"."purchase_order_status" (id, status)
VALUES
...
-- Dumping data for table "northwind"."purchase_orders"


INSERT INTO "northwind"."purchase_orders" (id, supplier_id, created_by, submitted_date, creation_date, status_id, expected_date, shipping_fee, taxes, payment_date, payment_amount, payment_method, notes, approved_by, approved_date, submitted_by)
VALUES
...
INSERT INTO "northwind"."sales_reports" (group_by, display, title, filter_row_source, default_value)
VALUES
('Category', 'Category', 'Sales By Category', 'SELECT DISTINCT "category" FROM "northwind"."products" ORDER BY "category";', '0');

INSERT INTO "northwind"."sales_reports" (group_by, display, title, filter_row_source, default_value)
VALUES
('country_region', 'Country/Region', 'Sales By Country', 'SELECT DISTINCT "country_region" FROM "northwind"."customers" ORDER BY "country_region";', '0');

INSERT INTO "northwind"."sales_reports" (group_by, display, title, filter_row_source, default_value)
VALUES
('Customer ID', 'Customer', 'Sales By Customer', 'SELECT DISTINCT "company" FROM "northwind"."customers" ORDER BY "company";', '0');

INSERT INTO "northwind"."sales_reports" (group_by, display, title, filter_row_source, default_value)
VALUES
('employee_id', 'Employee', 'Sales By Employee', 'SELECT DISTINCT "first_name" || '' '' || "last_name" AS "employee_name" FROM "northwind"."employees" ORDER BY "employee_name";', '0');

INSERT INTO "northwind"."sales_reports" (group_by, display, title, filter_row_source, default_value)
VALUES
('Product ID', 'Product', 'Sales by Product', 'SELECT DISTINCT "product_name" FROM "northwind"."products" ORDER BY "product_name";', '1');
...
--# Dumping data for table "northwind"."strings"


INSERT INTO "northwind"."strings" (string_id, string_data)
VALUES
(2, 'Northwind Traders');
INSERT INTO "northwind"."strings" (string_id, string_data)
VALUES
...
INSERT INTO "northwind"."strings" (string_id, string_data)
VALUES
(8, 'Purchase "northwind"."orders" were successfully created for | "northwind"."products"');
INSERT INTO "northwind"."strings" (string_id, string_data)
VALUES
(9, 'There are no "northwind"."products" below their respective reorder levels');
INSERT INTO "northwind"."strings" (string_id, string_data)
VALUES
(10, 'Must specify customer name!');
INSERT INTO "northwind"."strings" (string_id, string_data)
VALUES
(11, 'Restocking will generate purchase "northwind"."orders" for all "northwind"."products" below desired inventory levels.  Do you want to continue?');
INSERT INTO "northwind"."strings" (string_id, string_data)
VALUES
...
INSERT INTO "northwind"."strings" (string_id, string_data)
VALUES
(26, 'Purchase "northwind"."orders" were successfully submitted for | "northwind"."products".  Do you want to view the restocking report?');
INSERT INTO "northwind"."strings" (string_id, string_data)
VALUES
...
INSERT INTO "northwind"."strings" (string_id, string_data)
VALUES
(35, 'There are "northwind"."orders" with this product on back order.  Would you like to fill them now?');
INSERT INTO "northwind"."strings" (string_id, string_data)
VALUES
...
INSERT INTO "northwind"."strings" (string_id, string_data)
VALUES
(38, 'Initialize purchase, "northwind"."orders", and inventory data?');
INSERT INTO "northwind"."strings" (string_id, string_data)
VALUES
